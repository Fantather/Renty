...
{
    [Obsolete("This controller оставлен для сравнения. Use SearchController instead.")]
    public class OLDSearchController(IConfiguration configuration) : Controller
    {
        ...
        // TODO (Ольга): сейчас Index отдаёт мок (12 фейковых квартир). Ниже закомментирована версия с реальными данными,
        ...
        // Что для этого не хватает в хендлерах, описано в TODO в GetPropertiesHandler, GetPropertiesByMapHandler и GetPropertiesResponse.
        //
        // /// <summary>
