...
namespace Renty.Domain.Models.Properties
{
    ...
    public class PropertyDetails
    {
        ...
        // Количество этажей в здании (Для квартиры - этажность всего дома, для частного дома - количество этажей в доме)
        public int FloorsCount { get; set; } = 1;

        // Этаж, на котором находится объект (Может быть null, если это частный дом, вилла или отель целиком)
