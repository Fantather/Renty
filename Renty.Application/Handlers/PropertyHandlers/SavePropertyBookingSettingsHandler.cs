...
{
    public class SavePropertyBookingSettingsHandler : IRequestHandler<SavePropertyBookingSettingsCommand, OperationResult<Guid>>
    {
        private readonly OwnedPropertyService _ownedPropertyService;
        private readonly IPropertyRepository _propertyRepository;

        public SavePropertyBookingSettingsHandler(
        ...
        public async Task<OperationResult<Guid>> Handle(SavePropertyBookingSettingsCommand request, CancellationToken cancellationToken)
        {
            ...
            property.InstantBook = request.InstantBook;
