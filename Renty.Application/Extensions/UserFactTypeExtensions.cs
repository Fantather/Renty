...
namespace Renty.Application.Extensions
{
    ...
    public static class UserFactTypeExtensions
    {
        private static readonly Dictionary<UserFactTypeEnum, UserFactMeta> Meta = new()
        {
            ...
            [UserFactTypeEnum.InterestingFact] = new("star", "Поделитесь интересным фактом о себе", "Вспомните уникальный или примечательный факт о себе. Пример: «меня снял в видеоклипе» или «я умею жонглировать».", 40),
